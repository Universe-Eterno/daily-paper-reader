...
tldr: 针对现有自动提示词优化（APO）忽略问题重构与提示词设计之间相互依赖性的局限，本文提出Helix系统。Helix是一个双螺旋协同演化的多智能体框架，通过规划引导分解、双轨协同演化及策略驱动的问题生成，同步优化问题表述与提示指令。实验证明，该方法在12个基准测试中显著提升了LLM性能，展现了极高的优化效率和适应性。
selection_source: fresh_fetch
motivation: 现有的提示词优化方法通常将用户问题视为不可变量，忽略了问题重构与提示词设计之间相辅相成的耦合关系。
method: 提出一种三阶段协同演化框架，利用多智能体系统通过规划分解、双轨迭代优化和策略驱动生成，实现问题与提示词的联合优化。
result: "在12个基准测试中，Helix相比6种强基准模型实现了最高3.95%的性能提升，并保持了良好的优化效率。"
conclusion: 协同优化问题表述与提示指令能有效打破单一优化的瓶颈，为提升大语言模型在复杂任务中的表现提供了新路径。
---
